...
public class Email {
	...
	public Email(String fname,String lname) {
		...
		//Calling methods
		this.dep=this.setDep(); //Department
		this.password=this.generate_password(8); //password
		this.email=this.generate_email(); //email generat
	}
	//Generate mail method
	private String generate_email() {
		return this.fname.toLowerCase()+"."+this.lname.toLowerCase()+"@"+this.dep.toLowerCase()+".icloud.com";
				}

		//Asking for dept
	private String setDep() {
		System.out.println("Deperment codes \n1 for Sales \n2 for Development \n3 for Accounting \n0 for none ");
		...
		do {
			...
			if(choice=='Y'||choice=='y') {
				...
				if(temp.equals(this.password)) {
					...
					System.out.println("Password Channge Sucessfully");
				}
				else {
	...
	public void getInfo() {
		...
		System.out.println("Deparment :"+this.dep);
	...
	public void storefile() {
		try {
			FileWriter in=new FileWriter("c:\\Users\\ooart\\Desktop\\info.txt");
	...
	public void read_file() {
		try {
			FileReader f1=new FileReader("c:\\\\Users\\\\ooart\\\\Desktop\\\\info.txt");
			int i;
			while((i=f1.read())!=-1) {
